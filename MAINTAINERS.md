...
The compliance owner role is described in `GOVERNANCE.md`. It is the one that
must not stay unassigned: an unowned compliance calendar is the failure mode
that ends projects of this shape.
