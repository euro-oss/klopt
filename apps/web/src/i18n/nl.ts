...
export const nl = {
  ...
  'entryNew.lineDuplicated': 'Regel {line} gedupliceerd.',
  'entryNew.lineDeleted': 'Regel {line} verwijderd.',
  'entryNew.whyJournal': 'Kies eerst een dagboek.',
  'entryNew.whyDescription': 'Een journaalpost heeft een omschrijving nodig.',
  'entryNew.whyLines': 'Een journaalpost heeft minstens twee regels met een rekening.',
  'entryNew.whyBalance': 'Debet en credit zijn niet gelijk. Vul het verschil aan met =.',
  'entryNew.confirmTitle': 'Dit wordt geboekt',
  'entryNew.confirmBody': '{journal} op {date}, {lines} regels, “{description}”, voor in totaal',
  'entryNew.confirmHint':
    'Journaalposten zijn onveranderlijk: een correctie is een tegenboeking. Escape brengt je terug naar het concept.',
  'entryNew.confirm': 'Definitief boeken',
  'entryNew.confirmAndNext': 'Definitief boeken en volgende',
  'entryNew.confirmBack': 'Terug naar het concept',
  ...
  'invoices.stepForm': 'Nieuw / bewerken',
  'invoices.stepList': 'Lijst',
  ...
  'match.clearChoice': 'Keuze wissen',
  'match.stepQueue': 'Bankregels',
  'match.stepPanel': 'Koppelen',
  ...
  'inbox.stepList': 'Postvak',
  'inbox.stepReview': 'Nakijken',
  ...
  'keys.matchConfirm': 'Paneel openen / voorstel boeken',
  'keys.matchNext': 'Volgende',
  'keys.matchPrevious': 'Vorige',
  ...
  'keys.listNext': 'Volgende regel',
  'keys.listPrevious': 'Vorige regel',
  'keys.listOpen': 'Regel openen',
  'keys.listSelect': 'Regel selecteren',
  'keys.listSelectAll': 'Alles selecteren',
  'keys.listCopy': 'Kopiëren als tabel',
  'keys.listTypeAhead': 'Springen naar wat je typt',
  'keys.pickerChoose': 'Gemarkeerde rekening kiezen',
  'keys.pickerNext': 'Kiezen en volgend veld',
  'keys.pickerClose': 'Sluiten, waarde blijft',
  'keys.matchClear': 'Keuze in het paneel wissen',
  'keys.matchLeave': 'Paneel sluiten',
  'keys.inboxNext': 'Volgend stuk',
  'keys.inboxPrevious': 'Vorig stuk',
  'keys.inboxOpen': 'Stuk openen',
  'keys.inboxApprove': 'Concept maken',
  'keys.inboxSkip': 'Terzijde leggen',
  'keys.inboxLeave': 'Terug naar de lijst',
  'keys.invoiceSave': 'Concept opslaan',
  'keys.invoiceCancel': 'Annuleren',
  ...
  'table.selected_one': '1 regel geselecteerd.',
  'table.selected_other': '{count} regels geselecteerd.',
