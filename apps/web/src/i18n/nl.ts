...
export const nl = {
  ...
  'match.intro': '↑↓ kiest een regel · ↵ boekt het beste voorstel · 1–9 kiest een voorstel · x slaat over',
  ...
  'match.learnNote': 'Zelf kiezen zonder factuur wordt onthouden: de volgende keer dat er geld van dezelfde tegenpartij komt, staat deze rekening als voorstel bovenaan. Die regels staan onder Bank en kun je uitzetten.',
