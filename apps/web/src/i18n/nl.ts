...
export const nl = {
  ...
  'keys.listNext': 'Volgende regel (ook ↓)',
  'keys.listPrevious': 'Vorige regel (ook ↑)',
  'keys.listOpen': 'Regel openen',
  'keys.listSelect': 'Regel selecteren',
  'keys.listSelectAll': 'Alle ingeladen regels selecteren',
  'keys.listCopy': 'Selectie kopiëren voor een spreadsheet',
  'keys.listTypeAhead': 'Naar de eerste regel die begint met wat je typt',
